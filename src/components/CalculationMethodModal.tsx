...
const calculationMethods = [
  {
    ...
    description: 'Fajr: 18 degrees, Isha: 17 degrees, Region: Europe, The Far East, Parts of the USA'
  },
  {
    id: 2,
    name: 'Egyptian General Authority of Survey',
    description: 'Fajr: 19.5 degrees, Isha: 17.5 degrees, Region: Africa, Syria, Iraq, Lebanon, Malaysia, Parts of the USA'
  },
  {
    id: 3,
    name: 'University Of Islamic Sciences, Karachi',
    description: 'Fajr: 18 degrees, Isha: 18 degrees, Region: Pakistan, Bangladesh, India, Afghanistan, Parts of Europe'
  },
  {
    id: 4,
    name: 'Umm Al-Qura',
    description: 'Fajr: 18.5 Degrees (19 degrees before 1430 hijri), Isha: 90 minutes after the Sunset Prayer\n120 minutes (in Ramadan only), Region: The Arabian Peninsula'
  },
  {
    id: 5,
    name: 'Islamic Society of North America',
    description: 'Fajr: 15 degrees, Isha: 15 degrees, Region: Parts of the USA, Canada, Parts of the UK'
  },
  {
    id: 6,
